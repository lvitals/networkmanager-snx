...
/* Vendored from plasma-nm (libs/editor/vpnuiplugin.h, KDE Plasma project,
 * https://invent.kde.org/plasma/plasma-nm), unmodified except for this
 * notice. plasma-nm does not install this header or export a devel package
 * for it: plasmanm_editor/plasmanm_internal are private implementation
 * libraries of the plasma-nm monorepo, with no find_package()/pkg-config
 * entry point for out-of-tree consumers. This declaration is kept here only
 * to compile against the ABI already provided by the system's installed
 * libplasmanm_editor.so; see docs/PROVENANCE.md for the full explanation.
 * This file remains under the LGPL terms above; it does not relicense the
 * rest of this MIT-licensed project. */
